...
import { varAlpha, stylesMode } from 'src/theme/styles'; // Update according to your theme settings

import type { LabelColor, LabelVariant } from './types'; // Import the types

export const StyledLabel = styled(Box)(({
  theme,
  ownerState: { color, variant },
}: {
  theme: any; // Theme type (use the correct type for your setup)
  ownerState: {
    color: LabelColor;
